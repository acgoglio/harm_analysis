...
def t_tide(xin, dt=1, stime=None, lat=None,
    ...
    out['fu'] = fu # Frequency of tidal comp in cycles
    out['nameu'] = nameu
    ...
    out['lat'] = lat
    out['ltype'] = ltype
    out['pha'] = pha # Phase zero
    out['f'] = f    # Amp nodal correction
    out['vu'] = vu     # Pha nodal correction
    if stime is not None:
        out['stime'] = stime
    ...
    #for idx_comp in range (0,8):
        #print (nameu[idx_comp],tideconout[idx_comp][0],tideconout[idx_comp][2])
    return out
